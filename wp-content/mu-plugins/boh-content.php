	...
	return [
		...
		'sponsor' => [
			...
			'fields' => [
				...
				[
					'key'   => 'sponsor.form_extra_options',
					'label' => 'Commitment form - extra level choices',
					'type'  => 'textarea',
					'help'  => 'The "Sponsorship level" dropdown on the form is built from the cards above - one choice per active level, as "Level - Price" - and kept in step automatically. Anything typed here, one per line, is added after them (for example a silent-auction-only choice).',
				],
		...
		'donate' => [
			...
			'fields' => [
				[
					'key'   => 'donate.sponsorship_label',
					'label' => 'Donation form - sponsorship choice',
					'type'  => 'text',
					'help'  => 'The extra choice in the amount dropdown for sponsors paying their level. It takes any amount, like Custom Amount, and the donation is marked with this word on the receipt and in the donations list. Default: Sponsorship.',
				],
				[ 'key' => 'donate.confirm_eyebrow', 'label' => 'Confirmation page - small label', 'type' => 'text',
				  'help' => 'The page a donor lands on after paying. The receipt itself is generated by GiveWP; these are the words around it.' ],
				[ 'key' => 'donate.confirm_heading', 'label' => 'Confirmation page - heading', 'type' => 'text',
				  'help' => 'Use <em>words</em> to set part of it in magenta.' ],
				[ 'key' => 'donate.confirm_lede',    'label' => 'Confirmation page - line under the heading', 'type' => 'textarea' ],
				[ 'key' => 'donate.confirm_cta1',    'label' => 'Confirmation page - first button', 'type' => 'text' ],
				[ 'key' => 'donate.confirm_cta2',    'label' => 'Confirmation page - second button', 'type' => 'text' ],
